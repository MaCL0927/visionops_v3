...
- `/opt/visionops/edge/camera_bridge/orbbec336l_bridge/orbbec336l_bridge.env`
...
- 默认 env：`/opt/visionops_v3/edge/camera_bridge/orbbec336l_bridge/orbbec336l_bridge.env`
...
`edge/camera_bridge/orbbec336l_bridge/install_orbbec336l_bridge_service.sh`
...
```bash
cat /opt/visionops_v3/edge/camera_bridge/orbbec336l_bridge/orbbec336l_bridge.env
ls /opt/visionops_v3/edge/camera_bridge/orbbec336l_bridge/*.bak* 2>/dev/null
