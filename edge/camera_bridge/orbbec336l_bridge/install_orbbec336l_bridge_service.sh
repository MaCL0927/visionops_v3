...
append_env_default VISIONOPS_ORBBEC336L_COLOR_AUTO_EXPOSURE true
append_env_default VISIONOPS_ORBBEC336L_COLOR_EXPOSURE 50
...
append_env_default VISIONOPS_ORBBEC336L_SHARED_MEMORY_MODE 0664
