...
append_env_default VISIONOPS_CAMERA_WATCHDOG_RESTART_WHILE_UNHEALTHY true
append_env_default VISIONOPS_CAMERA_WATCHDOG_UNHEALTHY_RESTART_AFTER_S 30
append_env_default VISIONOPS_CAMERA_WATCHDOG_MAX_SERVICE_RESTARTS 10
append_env_default VISIONOPS_CAMERA_WATCHDOG_REBOOT_ENABLED true
