#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Small dependency-free RFC6455 WebSocket server for tube_pick_vision.
...
class WebSocketJsonServer:
    ...
    def start(self) -> None:
        ...
        self.thread = threading.Thread(target=self.server.serve_forever, name="tube-pick-websocket", daemon=True)
        self.thread.start()
