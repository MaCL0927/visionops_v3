#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Small dependency-free RFC6455 WebSocket server for detergent_grasp_vision.
...
class WebSocketJsonServer:
    ...
    def start(self) -> None:
        ...
        self.thread = threading.Thread(target=self.server.serve_forever, name="detergent-grasp-websocket", daemon=True)
        self.thread.start()
