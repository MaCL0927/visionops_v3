#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Dependency-free robot client for detergent-grasp integration testing."""
                    ...
                    if isinstance(document, dict):
                        ...
                        if document.get("type") == "detection":
                            ...
                            for item in document.get("items", []):
                                ...
                                print(
                                    "[ITEM] id={} target_type={} class_id={} px={} angle={}".format(
                                        target_id,
    ...
    try:
        while True:
            ...
            if command not in {"start", "stop", "trigger", "task"}:
                ...
                continue
            document = (
                {"type": "trigger", "task_id": "detergent_grasp", "request_id": request_id}
                if command == "task"
