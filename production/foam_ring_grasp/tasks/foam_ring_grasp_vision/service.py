    ...
    def _compact_result(
        ...
        *,
        ...
        return {
            ...
            "terminal_reject_display": terminal_reject_display,
            ...
            "scene_summary": {
                ...
                "selected_m39_3_1_tilt_evidence": deepcopy(
                    ((selected_instance or {}).get("m38_branch_a") or {}).get("m39_3_1_tilt_evidence") or {}
                ),
                "m39_3_1_tilt_evidence_summary": deepcopy(
                    scene.get("m39_3_1_tilt_evidence") or {}
                ),
                "selected_m39_3_2_ring_prior_surface": deepcopy(
                    ((selected_instance or {}).get("m38_branch_a") or {}).get("m39_3_2_ring_prior_surface") or {}
                ),
                "m39_3_2_ring_prior_surface_summary": deepcopy(
                    scene.get("m39_3_2_ring_prior_surface") or {}
                ),
                "selected_m39_3_3_conic_ring_surface": deepcopy(
                    ((selected_instance or {}).get("m38_branch_a") or {}).get("m39_3_3_conic_ring_surface") or {}
                ),
                "m39_3_3_conic_ring_surface_summary": deepcopy(
                    scene.get("m39_3_3_conic_ring_surface") or {}
                ),
                "selected_m39_3_4_analytic_conic_surface": deepcopy(
                    ((selected_instance or {}).get("m38_branch_a") or {}).get("m39_3_4_analytic_conic_surface") or {}
                ),
                "m39_3_4_analytic_conic_surface_summary": deepcopy(
                    scene.get("m39_3_4_analytic_conic_surface") or {}
                ),
                ...
                "m37_lightweight_candidate_limit": side_branch.get("lightweight_maximum_candidates_per_layer"),
                "m37_screen_attempt_count": side_branch.get("screen_attempt_count"),
                "m37_final_validation_count": side_branch.get("final_validation_count"),
            ...
            "timing_ms": {
                ...
                "m39_3_4_1_tilted_production_routing_ms": timing.get("m39_3_4_1_tilted_production_routing_ms"),
                ...
                "m37_final_validation_ms": hybrid_timing.get("m37_final_validation_ms"),
                ...
                "m37_fit_loop_ms": hybrid_timing.get("m37_fit_loop_ms", (
                    float(hybrid_timing.get("m37_screen_total_ms") or hybrid_timing.get("m37_fast_total_ms") or 0.0)
                    + float(hybrid_timing.get("m37_final_validation_ms") or 0.0)
                    + float(hybrid_timing.get("m37_local_accurate_ms") or 0.0)
                ) if (
                    hybrid_timing.get("m37_screen_total_ms") is not None
                    or hybrid_timing.get("m37_fast_total_ms") is not None
                    or hybrid_timing.get("m37_final_validation_ms") is not None
                    or hybrid_timing.get("m37_local_accurate_ms") is not None
                ) else None),
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="M37.5.1 staged pose-validation foam-ring persistent trigger service (M36.5-compatible API)")
...
def main() -> int:
    ...
    try:
        ...
        print(f"[FAIL] M37.5.1 hybrid service startup failed: {error}", file=sys.stderr)
        return 2
